...
input_array = ['Waltz', 'Tango', 'Viennese Waltz', 'Foxtrot', 'Cha Cha', 'Samba', 'Rumba', 
'Paso Doble', 'Jive']
...
"""
Using the same input string print out, in the same way, the array in alphabetical order 
